...
ローカルの作業ブランチをmasterに切り替えて、リモートリポジトリでマージされて更新されたmasterの情報をgit pullコマンドで取り込みましょう。

git logコマンドで ローカルとリモートのコミット履歴が同じことが確認できたら、git checkout -b コマンドで新しい作業ブランチを作成します。
